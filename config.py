...
data_arg.add_argument(
    "--data_tr", type=str, default=r"/home/hoo/Dataset/yfcc-sift-2000-train.hdf5", help=""
    "name of the dataset for train")
data_arg.add_argument(
    "--data_va", type=str, default=r"/home/hoo/Dataset/yfcc-sift-2000-val.hdf5", help=""
    "name of the dataset for valid")
data_arg.add_argument(
    "--data_te", type=str, default=r"/home/hoo/Dataset/yfcc-sift-2000-test.hdf5", help=""
...
loss_arg.add_argument(
    ...
    "clamping margin in essential loss")
